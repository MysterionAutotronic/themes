...
__conda_setup="$('/home/mysterion/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/mysterion/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/mysterion/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/mysterion/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# neofetch (display distro logo on terminal startup))
#neofetch --disable wm kernel resolution packages --color_blocks off

# chatgpt bind
export PATH=$PATH:/scripts/chatgpt.sh
export OPENAI_KEY=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

# isabelle bind
alias isabelle="~/Isabelle/Isabelle2022/Isabelle2022"

# ghidra bind
alias ghidra="/home/mysterion/ghidra_10.1.5_PUBLIC/ghidraRun"

# tor browser bind
alias tor="/home/mysterion/tor-browser/Browser/start-tor-browser"

#[ -f "/home/mysterion/.ghcup/env" ] && source "/home/mysterion/.ghcup/env" # ghcup-env
[ -f "/home/mysterion/.ghcup/env" ] && source "/home/mysterion/.ghcup/env" # ghcup-env
